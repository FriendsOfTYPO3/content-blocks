...
class TextFieldConfigurationTest extends UnitTestCase
{
    ...
    {
        $fieldConfiguration = TextFieldConfiguration::createFromArray($config);
    ...
    {
        $inputFieldConfiguration = TextFieldConfiguration::createFromArray([]);
