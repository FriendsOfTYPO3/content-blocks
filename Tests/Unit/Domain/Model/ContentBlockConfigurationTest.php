    ...
    public function checkContentBlockConfigurationDataProvider(): iterable
    {
        yield 'Check ContentBlockConfiguration' => [
            'contentBlock' => [
                ...
                'icon' => 'typo3conf/ext/example-local/ContentBlockIcon.svg',
                'composerJson' => [
            ...
            'expected' => [
                'create' => [
                    ...
                    'key' => 'example-local',
                    'path' => 'typo3conf/ext/example-local/',
                    'privatePath' => 'typo3conf/ext/example-local/Resources/Private/',
                    'publicPath' => 'typo3conf/ext/example-local/Resources/Public/',
                    'icon' => 'typo3conf/ext/example-local/ContentBlockIcon.svg',
                    ...
                    'frontendTemplatesPath' => 'typo3conf/ext/example-local/Resources/Private',
                    'frontendPartialsPath' => 'typo3conf/ext/example-local/Resources/Private/Partials',
                    'frontendLayoutsPath' => 'typo3conf/ext/example-local/Resources/Private/Layouts',
                    'EditorPreview.html' => 'typo3conf/ext/example-local/Resources/Private/EditorPreview.html',
                    'labelsXlfPath' => 'typo3conf/ext/example-local/Resources/Private/Language/Labels.xlf',
                    'EditorLLL' => 'LLL:typo3conf/ext/example-local/Resources/Private/Language/Labels.xlf:typo3-contentblocks.example-local',
                    'FrontendLLL' => 'LLL:typo3conf/ext/example-local/Resources/Private/Language/Labels.xlf:typo3-contentblocks.example-local',
                    'yaml' =>
                        [
                            'group' => 'common',
                            'fields' =>
    ...
    /* dump of an (old) complete ContentBlock configuration (THE all in example):
                'typo3-contentblocks_example-local' =>
                    [
                        ...
                        'key' => 'example-local',
                        'path' => 'typo3conf/ext/example-local/',
                        'srcPath' => 'typo3conf/ext/example-local/Resources/Private/',
                        'distPath' => 'typo3conf/ext/example-local/Resources/Public/',
                        'icon' => 'typo3conf/ext/example-local/ContentBlockIcon.svg',
                        'iconProviderClass' => 'TYPO3\\CMS\\Core\\Imaging\\IconProvider\\SvgIconProvider',
                        'CType' => 'typo3-contentblocks_example-local',
                        'fields' =>
                        ...
                        'frontendPartialsPath' => 'typo3conf/ext/example-local/Resources/Private/Partials',
                        'frontendLayoutsPath' => 'typo3conf/ext/example-local/Resources/Private/Layouts',
                        'EditorPreview.html' => '/var/www/html/.typo3/public/typo3conf/ext/example-local/Resources/Private/EditorPreview.html',
                        'EditorInterfaceXlf' => 'typo3conf/ext/example-local/Resources/Private/Language/EditorInterface.xlf',
                        'EditorLLL' => 'LLL:typo3conf/ext/example-local/Resources/Private/Language/EditorInterface.xlf:typo3-contentblocks.example-local',
                        'FrontendXlf' => 'typo3conf/ext/example-local/Resources/Private/Language/Frontend.xlf',
                        'FrontendLLL' => 'LLL:typo3conf/ext/example-local/Resources/Private/Language/Frontend.xlf:typo3-contentblocks.example-local',
                        'yaml' =>
                            [
                                'group' => 'common',
                                'fields' =>
