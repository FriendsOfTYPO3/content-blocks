...
final class TextFieldSchemaTest extends UnitTestCase
{
    public static function textFieldSchemaValidationWorksAsExpectedDataProvider(): iterable
    {
        yield 'Only type' => [
            'data' => (object)[
    ...
    #[Test]
    #[DataProvider('textFieldSchemaValidationWorksAsExpectedDataProvider')]
    public function textFieldSchemaValidationWorksAsExpected(object $data, bool $valid): void
    {
