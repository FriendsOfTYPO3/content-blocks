...
class CreateContentBlockCommand extends Command
{
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($input->getOption('extension')) {
            ...
            $basePath = $resolvedPackage->getPackagePath() . ContentBlockPathUtility::getSubDirectoryPath();
        } else {
            ...
            $basePath = $this->packageResolver->resolvePackage($extension)->getPackagePath() . ContentBlockPathUtility::getSubDirectoryPath();
        }
